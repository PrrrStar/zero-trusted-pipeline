...
vault write auth/approle/role/iise-argocd-deployer token_policies="iise-argocd-deployer"
vault read auth/approle/role/iise-argocd-deployer/role-id
vault write -force auth/approle/role/iise-argocd-deployer/secret-id